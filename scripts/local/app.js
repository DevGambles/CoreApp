...
var App = function() {
    ...
    var handleNav = function() {
        ...
        $(document).on("click", ".sidebar-nav-menu", function () {
     ...
     $(document).on("click", ".sidebar-nav-submenu", function () {
var link = $(this);
        ...
        $('a', colorList).click(function(e){
            ...
            if (theme === 'default') {
                ...
                if (themeLink.length) {
                    ...
                    $('link[href="styles/themes.css"]').before('<link id="theme-link" rel="stylesheet" href="' + theme + '">');
                    themeLink = $('#theme-link');
                }
            }
        });
