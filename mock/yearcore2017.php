...
//                $pipstock = 
                ...
                for ($i = 12; $i > 0; $i--) {
                    ...
                    for ($j=0;$j<sizeof($res3['result']);$j++){
                        ...
                        $pipe7 = array(/// top10_accounts_topup
                            ...
                            array(
                                '$group' => array(
                                    '_id' => array('account'=>'$account','currency' => '$topup_currency','code'=>'$code','country'=>'$country','operator_name'=>'$operator_name'),
                                    'count' => array('$sum' => 1),
                                    'amount' => array('$sum' => '$topup_amount')
                            ))
                        );
                        ...
                        $pipe8 = array(/// top10_accounts_paid
                            ...
                            array(
                                '$group' => array(
                                    '_id' => array('account'=>'$account','currency' => '$paid_currency','code'=>'$code','country'=>'$country','operator_name'=>'$operator_name'),
                                    'count' => array('$sum' => 1),
                                    'amount' => array('$sum' => '$paid_amount')
                            ))
                        );
                ...
                $obj['stats'] = $objarray;
                $obj['time'] = new MongoDate(strtotime('2018-01-01T00:00:01.000Z'));
                $db->yearcorestats->insert($obj);