...
//                $pipstock = 
                ...
                for ($i = 24; $i > 0; $i--) {
                    ...
                    $stats['topups_by_channel'] = array('web' => $ch_web, 'api' => $ch_api, 'pinp' => $ch_pinp, 'ivr' => $ch_ivr, 'date' => date('m.Y', $start), 'ts' => new MongoDate($start));
